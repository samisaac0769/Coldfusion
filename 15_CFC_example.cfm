...
<body>
    ...
    <center>
        <table>
            ...
            <tr><td>multiply(1,2,3,4)</td><td>createobject</td><td>
             <cfset local.newmethod=createObject("component", "Component/15_CFC_example" )>
    <cfset local.ans1=local.newmethod.multiply(1,2,3,4)>
    <cfoutput>#local.ans1#</cfoutput></td></tr>


            <tr><td>multiply(1,2,3)</td><td>cfinvoke tag</td><td>   
    ...
    <cfoutput>#ans2#</cfoutput></td></tr>

            <tr><td>multiply(1,2)</td><td>cfobject tag</td><td>
                <cfobject component="Component/15_CFC_example" name="mulitiply">
    <cfset local.ans3 = mulitiply.multiply(1, 2)>
    <cfoutput>#local.ans3#</cfoutput></td></tr>
        </table>
    <center>
